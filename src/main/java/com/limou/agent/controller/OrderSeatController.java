...
public class OrderSeatController {
     ...
     */
    @PostMapping("save")
    public boolean save(@RequestBody OrderSeat orderSeat) {
        return orderSeatService.save(orderSeat);
    }
    ...
    public boolean remove(@PathVariable Long id) {
        return orderSeatService.removeById(id);
    }
     ...
     */
    @PutMapping("update")
    public boolean update(@RequestBody OrderSeat orderSeat) {
        return orderSeatService.updateById(orderSeat);
    }
